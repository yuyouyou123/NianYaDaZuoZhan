...
function MiniIcoInfo:isIco(loginScene)
    ...
    if self.info.isOver then
        GameManager:getInstance():getMusicAndSoundManager():playerSoundWithFile("audio/boom.mp3")
        ...
        GameManager:getInstance():getMusicAndSoundManager():playerSoundWithFile("audio/ico.mp3")
